...
<asp:Content ID="Content3" ContentPlaceHolderID="Assets" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        var ControllerActions = {
            ...
            CopyBoughtPointsToDivision: '<%= Url.Action("CopyBoughtPointsToDivision", "BoughtPointGame") %>/'
        }

        $(document).ready(function() {
            InitAutoCompleteUtil('#SearchText', "/AutoComplete/ByDivisionName");
            ...
            $("#ajaxDataTable").jqGrid({
                ...
                datatype: 'json',
                mtype: 'GET',
                colNames: ['División', 'Desde gavela', 'Hasta gavela', 'Puntos comprados', 'Precio macho', 'Precio hembra', '', ''],
                colModel: [
                    { name: 'DivisionName', index: 'Division.Name', sortable: true, width: 150 },
                    { name: 'InitialSpread', index: 'InitialSpread', sortable: true, width: 80 },
                    { name: 'FinalSpread', index: 'FinalSpread', sortable: true, width: 80 },
                    { name: 'BoughtPoints', index: 'BoughtPoints', sortable: true, width: 150 },
                    { name: 'Male', index: 'Male', sortable: true, width: 150 },
                    { name: 'Female', index: 'Female', sortable: true, width: 150 },
                ...
                rowNum: 10,
                rowList: [10, 20, 50],
                sortname: 'Division.Name',
                sortorder: 'asc',
                viewrecords: true,
                caption: 'Compra de puntos',
            ...
            $("#copy-dialog").dialog({
                ...
                buttons: {
                    ...
                    Ok: function() {
                        ...
                        $.post(ControllerActions.CopyBoughtPointsToDivision,
        ...
        function activateDelete() {
            $('.delete-link').click(function() {
                ...
                var name = $("#ajaxDataTable").jqGrid('getRowData', this.id).DivisionName + "<br/> " +
                    'Puntos comprados: ' + $("#ajaxDataTable").jqGrid('getRowData', this.id).BoughtPoints + '<br/> ' +
                    'Gavela desde: ' + $("#ajaxDataTable").jqGrid('getRowData', this.id).InitialSpread + ' Hasta: ' +
                    $("#ajaxDataTable").jqGrid('getRowData', this.id).FinalSpread + ' Anotaciones';
                ...
                $("#ajaxDataTable").jqGrid('delGridRow', this.id, {
                    ...
                    beforeShowForm: function(formid) {
                        $(".delmsg", formid).html("Desea eliminar esta compra de puntos?<br/> " + name);
                    }
                });
            });
        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Compra de Puntos para Juego - Listado
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Listado de Compra de Puntos para Juego
    </h2>
    <div class="searchbox">
        Buscar :
    ...
    <div id="copy-dialog" title="Copiar compra de puntos">
