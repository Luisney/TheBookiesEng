...
<asp:Content ID="Content3" ContentPlaceHolderID="Assets" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        var ControllerActions = {
            ...
            CopyBoughtPointsToDivision: '<%= Url.Action("CopyBoughtPointsToDivision", "BoughtPointTotal") %>/'
        }
        ...
        $(document).ready(function() {
            ...
            $("#ajaxDataTable").jqGrid({
                ...
                datatype: 'json',
                mtype: 'GET',
                colNames: ['División', 'Desde carreraje', 'Hasta carreraje', 'Puntos comprados', 'Precio macho', 'Precio hembra', '', ''],
                colModel: [
                    { name: 'DivisionName', index: 'Division.Name', sortable: true, width: 150 },
                    { name: 'UnderTop', index: 'UnderTop', sortable: true, width: 80 },
                    { name: 'UpperTop', index: 'UpperTop', sortable: true, width: 80 },
        ...
        function activateDelete() {
            $('.delete-link').click(function() {
                ...
                var name = $("#ajaxDataTable").jqGrid('getRowData', this.id).DivisionName + "<br/> " +
                    ...
                    'Desde: ' + $("#ajaxDataTable").jqGrid('getRowData', this.id).UnderTop + ' Hasta: ' +
                    $("#ajaxDataTable").jqGrid('getRowData', this.id).UpperTop + ' Anotaciones';
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Compra de Puntos para Totales - Listado
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Listado de Compra de Puntos para Totales
    </h2>
    <div class="searchbox">
        Buscar :
