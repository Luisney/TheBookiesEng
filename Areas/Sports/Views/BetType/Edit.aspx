...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Editar
    <%
        this.HtmlNamePrefix = "BetTypeViewModel"; %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Editando tipo de apuesta:
        <%= Model.Name %></h2>
    ...
    <fieldset>
        ...
        <%--
            // review for deletion
            <p>
                <%= this.CheckBox( C => C.CalcTargetScoreBetModifier ).Label( "Añadir puntos:" ).Attr( "title", "Activar para añadir puntos del ticket al puntaje" ).Attr( "class", "jqtooltipWE" )%>
            </p>
            <p>
                <%= this.CheckBox( C => C.CalcTargetScoreOverScore ).Label( "Añadir gavela:" ).Attr( "title", "Activar para añadir gavela al puntaje" ).Attr( "class", "jqtooltipWE" )%>
            </p>
        --%>
        <p>
