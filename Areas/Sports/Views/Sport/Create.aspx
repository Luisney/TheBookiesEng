...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Deportes - Crear Deporte
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <%
            this.HtmlNamePrefix = "Sport"; %>
        Crear Deporte
    </h2>
    <%
        if( !ViewData.ModelState.IsValid )
        {%>
    <div id="validation-summary-errors">
        <%= Html.ClientSideValidation<Sport>(this.HtmlNamePrefix) %>
    ...
    <fieldset>
        ...
        <p>
            <%= this.TextBox(c => c.Maximum).Label("Máximo") %>
