...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="frm" action="/Recargas/Comision/Crear" onsubmit="return postData()" method="post">
    <fieldset>
        <table>
            <tr>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <%=detail.RechargeProduct.Name %><input type="hidden" name="Comisiones[<%=r%>].Id"
                        value="<%=detail.RechargeProduct.ProductId %>" />
                </td>
                <td class="comision">
                    <input id="User<%=r%>" name="Comisiones[<%=r%>].User" type="text" maxlength="5" onblur="chkfld(this)"
                        value="<%=detail.CommisUser%>" />
                </td>
                <td class="comision">
                    <input id="Terminal<%=r%>" name="Comisiones[<%=r%>].Terminal" type="text" maxlength="5"
                        onblur="chkfld(this)" value="<%=detail.CommisTerminal%>" />
                </td>
                <td class="comision">
                    <input id="Banca<%=r%>" name="Comisiones[<%=r%>].Banca" type="text" maxlength="5"
                        onblur="chkfld(this)" value="<%=detail.CommisSportBook%>" />
                </td>
                <td class="comision">
                    <input id="Centro<%=r%>" name="Comisiones[<%=r%>].Centro" type="text" maxlength="5"
                        onblur="chkfld(this)" value="<%=detail.CommisStoringCenter%>" />
                </td>
                <td class="comision">
                    <input id="Utilida<%=r%>" name="Comisiones[<%=r%>].Utilidad" type="text" maxlength="5"
                        onblur="chkfld(this)" value="<%=detail.CommisStoringCenter%>" />
                </td>
            </tr>
            <% 
