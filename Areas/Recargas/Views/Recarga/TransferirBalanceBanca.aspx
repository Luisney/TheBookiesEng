...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Transferir Balance a Bancas
    </h2>
    <form id="frmTransf" action="/Recargas/Recarga/TransferirBalanceBanca" onsubmit="return postData()" method="post">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Assets" runat="server">
    ...
    <script type="text/javascript">
        ...
        function postData() {
            ...
            $.ajax({
                type: "POST",
                url: "/Recargas/Recarga/TransferirBalanceBanca",
                data: elements,
                dataType: "text",
