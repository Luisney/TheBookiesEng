    ...
    $.TokenList = function(input, settings) {
      ...
      .insertBefore(input_token);
        ...
        function add_token(item) {
            ...
            settings.selectCallback(li_data.id);
        }
        ...
        function run_search(query) {
            // Cache turned off, turn on as needed
            ...
            if (cached_results) {
                ...
                if (settings.method == "POST") {
                    $.post(settings.url + queryStringDelimiter + settings.queryParam + "=" + query, extraParams, callback, settings.contentType);
                } else {
                    $.get(settings.url + queryStringDelimiter + settings.queryParam + "=" + query, extraParams, callback, settings.contentType);
                }
            }
        }
    };
