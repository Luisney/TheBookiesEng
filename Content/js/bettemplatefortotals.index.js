...
$(document).ready(function () {
    ...
    $('#SportForSeries').change(function () {
        ...
        $.getJSON(ControllerActions.GetDefaultBetTypeForSport, { SportCode: selectedSportCode, BetTemplateType: BetTemplateType }, function (outerData) {
            ...
            $.getJSON(ControllerActions.GetBetTypesWithPeriodAppendedBySport, { SportCode: selectedSportCode, AppliesToTotals: true }, function (data) {
    ...
    $("#ajaxDataTable").jqGrid({
        ...
        colModel: [
               ...
               { name: 'DefaultBetType', index: 'BetTemplate.Sport.DefaultBetTypeForTotals.Name', sortable: true, width: 150 },
               { name: 'DefaultBetTypeMales', index: 'DefaultBetTemplateForTotals.GlobalScore', sortable: true, width: 150 },
    ...
    $("#BetTemplateDetailAjaxDataTable").jqGrid({
        ...
        rowNum: 20,
        rowList: [10, 20, 50],
        sortname: 'DefaultBetTemplateDetailForTotals.LocalMale',
        sortorder: 'desc',
        viewrecords: true,
        caption: 'Precios',
        gridComplete: function () {
    ...
    $('#SportId').cascade({
        ...
        extraParams: { appliesToTotals: true }
    });
    ...
    $('#PeriodId').cascade({
        ...
        dependentStartingLabel: "Selecciona una",
        dependentLoadingLabel: "Cargando opciones",
        extraParams: { SportId: function () { return $('#SportId').val(); }, AppliestoTotals: true },
        firstOptionLabel: "Selecciona una"
    });
