...
(function ($) {
    ...
    $.fn.editInPlace.defaults = {
        ...
        paramsCallback: function (domElement) { return "" }, // function: get extra parameters to send in the request, example: another_name=sergio&aother_last_name=reyes extra paramters sent via the post request to the server
    ...
    $.extend(InlineEditor.prototype, {
        ...
        handleSubmitToCallback: function (enteredText) {
			...
			this.settings.params, this.savingAnimationCallbacks(), this.settings.paramsCallback);
        ...
        handleSubmitToServer: function (enteredText) {
			...
			+ ((this.settings.paramsCallback) ? '&' + this.settings.paramsCallback(this.dom) : '')
