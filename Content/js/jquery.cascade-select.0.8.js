/*
* jQuery Cascading Select Lists plug-in 0.8.5
*
    ...
    $.extend($.fn, {
        cascade: function(options) {
            ...
            var options = $.extend({}, $.fn.cascade.defaults, {
                ...
                firstOptionLabel: options.firstOptionLabel
            }, options);
                ...
                sourceDdl.change(function() {
                    ...
                    $.getJSON(options.source, data, function(response) {
                        ...
                        if (response.length > 0) {
                            if (options.firstOptionLabel != null) {
                                dependendentDdl.append('<option >' + options.firstOptionLabel + '</option>');
                            }
